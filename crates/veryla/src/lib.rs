...
impl From<SimType> for veryla_metadata::SimType {
    fn from(x: SimType) -> Self {
        match x {
            SimType::Verilator => veryla_metadata::SimType::Verilator,
            SimType::Vcs => veryla_metadata::SimType::Vcs,
            SimType::Vivado => veryla_metadata::SimType::Vivado,
        }
    }
}
...
impl From<BumpKind> for veryla_metadata::BumpKind {
    fn from(x: BumpKind) -> Self {
        match x {
            BumpKind::Major => veryla_metadata::BumpKind::Major,
            BumpKind::Minor => veryla_metadata::BumpKind::Minor,
            BumpKind::Patch => veryla_metadata::BumpKind::Patch,
        }
    }
}
