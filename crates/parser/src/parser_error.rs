...
impl From<&str> for TokenType {
    fn from(value: &str) -> Self {
        match value {
            ...
            "Operator12Term" => TokenType::Operator12,
            ...
            "SequenceTerm" => TokenType::Sequence,
            ...
            "HighTerm" => TokenType::High,
            "I32Term" => TokenType::I32,
            "I64Term" => TokenType::I64,
            "IfEnableTerm" => TokenType::IfEnable,
            "IfTerm" => TokenType::If,
            ...
            "LowTerm" => TokenType::Low,
            "LsbTerm" => TokenType::Lsb,
            "ModportTerm" => TokenType::Modport,
            "EntityTerm" => TokenType::Entity,
            "MsbTerm" => TokenType::Msb,
            "NegedgeTerm" => TokenType::Negedge,
            "OpenCollectorTerm" => TokenType::OpenCollector,
            "OpenDrainTerm" => TokenType::OpenDrain,
...
impl std::fmt::Display for TokenType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let text = match self {
            ...
            TokenType::OpenCollector => "open_collector",
            TokenType::OpenDrain => "open_drain",
