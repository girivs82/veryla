...
use crate::veryla_grammar_trait::DelayNumber;
...
pub trait VerylaWalker {
    ...
    fn string_literal(&mut self, arg: &StringLiteral) {
        ...
        self.veryla_token(&arg.string_literal_token);
    ...
    fn exponent(&mut self, arg: &Exponent) {
        ...
        self.veryla_token(&arg.exponent_token);
    ...
    fn fixed_point(&mut self, arg: &FixedPoint) {
        ...
        self.veryla_token(&arg.fixed_point_token);
    ...
    fn base_less(&mut self, arg: &BaseLess) {
        ...
        self.veryla_token(&arg.base_less_token);
    ...
    fn assignment_operator(&mut self, arg: &AssignmentOperator) {
        ...
        self.veryla_token(&arg.assignment_operator_token);
    ...
    fn operator01(&mut self, arg: &Operator01) {
        ...
        self.veryla_token(&arg.operator01_token);
    ...
    fn operator02(&mut self, arg: &Operator02) {
        ...
        self.veryla_token(&arg.operator02_token);
    ...
    fn operator03(&mut self, arg: &Operator03) {
        ...
        self.veryla_token(&arg.operator03_token);
    ...
    fn operator04(&mut self, arg: &Operator04) {
        ...
        self.veryla_token(&arg.operator04_token);
    ...
    fn operator05(&mut self, arg: &Operator05) {
        ...
        self.veryla_token(&arg.operator05_token);
    ...
    fn operator06(&mut self, arg: &Operator06) {
        ...
        self.veryla_token(&arg.operator06_token);
    ...
    fn operator07(&mut self, arg: &Operator07) {
        ...
        self.veryla_token(&arg.operator07_token);
    ...
    fn operator08(&mut self, arg: &Operator08) {
        ...
        self.veryla_token(&arg.operator08_token);
    ...
    fn operator09(&mut self, arg: &Operator09) {
        ...
        self.veryla_token(&arg.operator09_token);
    ...
    fn operator10(&mut self, arg: &Operator10) {
        ...
        self.veryla_token(&arg.operator10_token);
    ...
    fn operator11(&mut self, arg: &Operator11) {
        ...
        self.veryla_token(&arg.operator11_token);
    ...
    fn unary_operator(&mut self, arg: &UnaryOperator) {
        ...
        self.veryla_token(&arg.unary_operator_token);
    ...
    fn back_quote(&mut self, arg: &BackQuote) {
        ...
        self.veryla_token(&arg.back_quote_token);
    ...
    fn colon(&mut self, arg: &Colon) {
        ...
        self.veryla_token(&arg.colon_token);
    ...
    fn colon_colon(&mut self, arg: &ColonColon) {
        ...
        self.veryla_token(&arg.colon_colon_token);
    ...
    fn colon_colon_l_angle(&mut self, arg: &ColonColonLAngle) {
        ...
        self.veryla_token(&arg.colon_colon_l_angle_token);
    ...
    fn dot_dot(&mut self, arg: &DotDot) {
        ...
        self.veryla_token(&arg.dot_dot_token);
    ...
    fn dot_dot_equ(&mut self, arg: &DotDotEqu) {
        ...
        self.veryla_token(&arg.dot_dot_equ_token);
    ...
    fn dot(&mut self, arg: &Dot) {
        before!(self, dot, arg);
        self.veryla_token(&arg.dot_token);
        after!(self, dot, arg);
    }
    ...
    fn equ(&mut self, arg: &Equ) {
        before!(self, equ, arg);
        self.veryla_token(&arg.equ_token);
        after!(self, equ, arg);
    }
    ...
    fn hash(&mut self, arg: &Hash) {
        ...
        self.veryla_token(&arg.hash_token);
        after!(self, hash, arg);
    }
    ...
    fn quote_l_brace(&mut self, arg: &QuoteLBrace) {
        ...
        self.veryla_token(&arg.quote_l_brace_token);
    ...
    fn l_angle(&mut self, arg: &LAngle) {
        ...
        self.veryla_token(&arg.l_angle_token);
    ...
    fn l_brace(&mut self, arg: &LBrace) {
        ...
        self.veryla_token(&arg.l_brace_token);
    ...
    fn l_bracket(&mut self, arg: &LBracket) {
        ...
        self.veryla_token(&arg.l_bracket_token);
    ...
    fn l_paren(&mut self, arg: &LParen) {
        ...
        self.veryla_token(&arg.l_paren_token);
    ...
    fn minus_colon(&mut self, arg: &MinusColon) {
        ...
        self.veryla_token(&arg.minus_colon_token);
    ...
    fn minus_g_t(&mut self, arg: &MinusGT) {
        ...
        self.veryla_token(&arg.minus_g_t_token);
    ...
    fn plus_colon(&mut self, arg: &PlusColon) {
        ...
        self.veryla_token(&arg.plus_colon_token);
    ...
    fn r_angle(&mut self, arg: &RAngle) {
        ...
        self.veryla_token(&arg.r_angle_token);
    ...
    fn r_brace(&mut self, arg: &RBrace) {
        ...
        self.veryla_token(&arg.r_brace_token);
    ...
    fn r_bracket(&mut self, arg: &RBracket) {
        ...
        self.veryla_token(&arg.r_bracket_token);
    ...
    fn r_paren(&mut self, arg: &RParen) {
        ...
        self.veryla_token(&arg.r_paren_token);
    ...
    fn semicolon(&mut self, arg: &Semicolon) {
        ...
        self.veryla_token(&arg.semicolon_token);
    ...
    fn star(&mut self, arg: &Star) {
        ...
        self.veryla_token(&arg.star_token);
        after!(self, star, arg);
    }
    ...
    fn always_comb(&mut self, arg: &AlwaysComb) {
        ...
        self.veryla_token(&arg.always_comb_token);
        after!(self, always_comb, arg);
    }

    /// Semantic action for non-terminal 'Sequence'
    fn sequence(&mut self, arg: &Sequence) {
        before!(self, sequence, arg);
        self.veryla_token(&arg.sequence_token);
        after!(self, sequence, arg);
    }

    /// Semantic action for non-terminal 'As'
    fn r#as(&mut self, arg: &As) {
        before!(self, r#as, arg);
        self.veryla_token(&arg.as_token);
        after!(self, r#as, arg);
    }
    ...
    fn assign(&mut self, arg: &Assign) {
        ...
        self.veryla_token(&arg.assign_token);
    ...
    fn bit(&mut self, arg: &Bit) {
        before!(self, bit, arg);
        self.veryla_token(&arg.bit_token);
        after!(self, bit, arg);
    }
    ...
    fn case(&mut self, arg: &Case) {
        ...
        self.veryla_token(&arg.case_token);
        after!(self, case, arg);
    }

    /// Semantic action for non-terminal 'Power'
    fn power(&mut self, arg: &Power) {
        before!(self, power, arg);
        self.veryla_token(&arg.power_token);
        after!(self, power, arg);
    }

    /// Semantic action for non-terminal 'PowerPosedge'
    fn power_posedge(&mut self, arg: &PowerPosedge) {
        before!(self, power_posedge, arg);
        self.veryla_token(&arg.power_posedge_token);
        after!(self, power_posedge, arg);
    }

    /// Semantic action for non-terminal 'PowerNegedge'
    fn power_negedge(&mut self, arg: &PowerNegedge) {
        before!(self, power_negedge, arg);
        self.veryla_token(&arg.power_negedge_token);
        after!(self, power_negedge, arg);
    }

    /// Semantic action for non-terminal 'Const'
    fn r#const(&mut self, arg: &Const) {
        before!(self, r#const, arg);
        self.veryla_token(&arg.const_token);
    ...
    fn defaul(&mut self, arg: &Defaul) {
        ...
        self.veryla_token(&arg.default_token);
    ...
    fn r#else(&mut self, arg: &Else) {
        ...
        self.veryla_token(&arg.else_token);
    ...
    fn embed(&mut self, arg: &Embed) {
        ...
        self.veryla_token(&arg.embed_token);
    ...
    fn r#enum(&mut self, arg: &Enum) {
        ...
        self.veryla_token(&arg.enum_token);
    ...
    fn export(&mut self, arg: &Export) {
        ...
        self.veryla_token(&arg.export_token);
    ...
    fn f32(&mut self, arg: &F32) {
        before!(self, f32, arg);
        self.veryla_token(&arg.f32_token);
        after!(self, f32, arg);
    }
    ...
    fn f64(&mut self, arg: &F64) {
        before!(self, f64, arg);
        self.veryla_token(&arg.f64_token);
        after!(self, f64, arg);
    }
    ...
    fn r#final(&mut self, arg: &Final) {
        ...
        self.veryla_token(&arg.final_token);
    ...
    fn r#for(&mut self, arg: &For) {
        ...
        self.veryla_token(&arg.for_token);
    ...
    fn function(&mut self, arg: &Function) {
        ...
        self.veryla_token(&arg.function_token);
    ...
    fn i32(&mut self, arg: &I32) {
        before!(self, i32, arg);
        self.veryla_token(&arg.i32_token);
        after!(self, i32, arg);
    }
    ...
    fn i64(&mut self, arg: &I64) {
        before!(self, i64, arg);
        self.veryla_token(&arg.i64_token);
        after!(self, i64, arg);
    }
    ...
    fn r#if(&mut self, arg: &If) {
        ...
        self.veryla_token(&arg.if_token);
        after!(self, r#if, arg);
    }
    ...
    fn import(&mut self, arg: &Import) {
        ...
        self.veryla_token(&arg.import_token);
    ...
    fn r#in(&mut self, arg: &In) {
        ...
        self.veryla_token(&arg.in_token);
        after!(self, r#in, arg);
    }
    ...
    fn include(&mut self, arg: &Include) {
        ...
        self.veryla_token(&arg.include_token);
    ...
    fn initial(&mut self, arg: &Initial) {
        ...
        self.veryla_token(&arg.initial_token);
    ...
    fn inout(&mut self, arg: &Inout) {
        ...
        self.veryla_token(&arg.inout_token);
    ...
    fn input(&mut self, arg: &Input) {
        ...
        self.veryla_token(&arg.input_token);
    ...
    fn inside(&mut self, arg: &Inside) {
        ...
        self.veryla_token(&arg.inside_token);
    ...
    fn inst(&mut self, arg: &Inst) {
        ...
        self.veryla_token(&arg.inst_token);
        after!(self, inst, arg);
    }
    ...
    fn interface(&mut self, arg: &Interface) {
        ...
        self.veryla_token(&arg.interface_token);
    ...
    fn r#let(&mut self, arg: &Let) {
        ...
        self.veryla_token(&arg.let_token);
    ...
    fn logic(&mut self, arg: &Logic) {
        ...
        self.veryla_token(&arg.logic_token);
    ...
    fn lsb(&mut self, arg: &Lsb) {
        before!(self, lsb, arg);
        self.veryla_token(&arg.lsb_token);
        after!(self, lsb, arg);
    }
    ...
    fn modport(&mut self, arg: &Modport) {
        ...
        self.veryla_token(&arg.modport_token);
    ...
    fn msb(&mut self, arg: &Msb) {
        before!(self, msb, arg);
        self.veryla_token(&arg.msb_token);
        after!(self, msb, arg);
    }
    ...
    fn output(&mut self, arg: &Output) {
        ...
        self.veryla_token(&arg.output_token);
    ...
    fn outside(&mut self, arg: &Outside) {
        ...
        self.veryla_token(&arg.outside_token);
    ...
    fn package(&mut self, arg: &Package) {
        ...
        self.veryla_token(&arg.package_token);
    ...
    fn param(&mut self, arg: &Param) {
        ...
        self.veryla_token(&arg.param_token);
    ...
    fn proto(&mut self, arg: &Proto) {
        ...
        self.veryla_token(&arg.proto_token);
    ...
    fn r#pub(&mut self, arg: &Pub) {
        ...
        self.veryla_token(&arg.pub_token);
    ...
    fn r#ref(&mut self, arg: &Ref) {
        ...
        self.veryla_token(&arg.ref_token);
    ...
    fn repeat(&mut self, arg: &Repeat) {
        ...
        self.veryla_token(&arg.repeat_token);
    ...
    fn r#return(&mut self, arg: &Return) {
        ...
        self.veryla_token(&arg.return_token);
    ...
    fn r#break(&mut self, arg: &Break) {
        ...
        self.veryla_token(&arg.break_token);
    ...
    fn step(&mut self, arg: &Step) {
        ...
        self.veryla_token(&arg.step_token);
        after!(self, step, arg);
    }
    ...
    fn strin(&mut self, arg: &Strin) {
        ...
        self.veryla_token(&arg.string_token);
    ...
    fn r#struct(&mut self, arg: &Struct) {
        ...
        self.veryla_token(&arg.struct_token);
    ...
    fn switch(&mut self, arg: &Switch) {
        ...
        self.veryla_token(&arg.switch_token);
    ...
    fn union(&mut self, arg: &Union) {
        ...
        self.veryla_token(&arg.union_token);
    ...
    fn r#unsafe(&mut self, arg: &Unsafe) {
        ...
        self.veryla_token(&arg.unsafe_token);
    ...
    fn tri(&mut self, arg: &Tri) {
        before!(self, tri, arg);
        self.veryla_token(&arg.tri_token);
        after!(self, tri, arg);
    }
    ...
    fn r#type(&mut self, arg: &Type) {
        ...
        self.veryla_token(&arg.type_token);
    ...
    fn u32(&mut self, arg: &U32) {
        before!(self, u32, arg);
        self.veryla_token(&arg.u32_token);
        after!(self, u32, arg);
    }
    ...
    fn u64(&mut self, arg: &U64) {
        before!(self, u64, arg);
        self.veryla_token(&arg.u64_token);
        after!(self, u64, arg);
    }
    ...
    fn var(&mut self, arg: &Var) {
        before!(self, var, arg);
        self.veryla_token(&arg.var_token);
        after!(self, var, arg);
    }
    ...
    fn dollar_identifier(&mut self, arg: &DollarIdentifier) {
        ...
        self.veryla_token(&arg.dollar_identifier_token);
    ...
    fn identifier(&mut self, arg: &Identifier) {
        ...
        self.veryla_token(&arg.identifier_token);
    ...
    fn delay_number(&mut self, arg: &DelayNumber) {
        before!(self, delay_number, arg);
        match arg {
            DelayNumber {hash: _x, integral_number: y} => self.integral_number(&y),
        };
        after!(self, delay_number, arg);
    }
    ...
    /// Semantic action for non-terminal 'PowerDomain'
    fn power_domain(&mut self, arg: &PowerDomain) {
        before!(self, power_domain, arg);
        self.back_quote(&arg.back_quote);
        self.identifier(&arg.identifier);
        after!(self, power_domain, arg);
    }
    ...
    fn sequence_power(&mut self, arg: &SequencePower) {
        before!(self, sequence_power, arg);
        self.hierarchical_identifier(&arg.hierarchical_identifier);
        after!(self, sequence_power, arg);
    }
    ...
    fn generate_item(&mut self, arg: &GenerateItem) {
        ...
        match arg {
            ...
            GenerateItem::SequenceDeclaration(x) => {
                self.sequence_declaration(&x.sequence_declaration)
            }
    ...
    fn embed_content(&mut self, arg: &EmbedContent) {
        ...
        self.veryla_token(&arg.embed_content_token);
    ...
    fn veryla(&mut self, arg: &Veryla) {
        before!(self, veryla, arg);
        self.start(&arg.start);
        for x in &arg.veryla_list {
            self.description_group(&x.description_group);
        }
        after!(self, veryla, arg);
    }
...
pub trait Handler: VerylaGrammarTrait {
